...
<div class="flex w-screen h-screen">
	<div class="m-auto">
		<img class="mb-5 w-80" src="/imgs/logos/MonsterBox_Text.svg" alt="MonsterBox">
		<form class="flex flex-col text-center m-auto" on:submit|preventDefault="{handleLogin}">
			<input class="bg-gray-800 border border-transparent outline-none rounded py-2 px-3 mb-5 transition focus-visible:border-mb-red hover:border-mb-red duration-300" type="email" placeholder="mail@email.com" bind:value="{email}" />
			<input type="submit"
